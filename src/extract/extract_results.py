        ...
        for line in tqdm(f):
            ...
            if vals and (dataset_guess != "unknown" or metric_guess != "unknown"):
                for v in vals:
                    ...
                    # Confidence scoring
                    conf = "low"
                    if dataset_guess != "unknown" and metric_guess != "unknown": conf = "high"
                    elif dataset_guess != "unknown" or metric_guess != "unknown": conf = "medium"
                    ...
                    results.append({
                        ...
                        "model_guess": "unknown", # placeholder for future refinement
