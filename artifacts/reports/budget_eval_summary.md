...
| operator_no_evidence | Run operator; return answer text only (evidence suppressed). | 97.5 | 100.0 | 0.0 | 0.066 | $0.00 |
| operator_with_evidence | Full pipeline: operator + evidence collection (current syste | 97.5 | 100.0 | 100.0 | 0.044 | $0.00 |
